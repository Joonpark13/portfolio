      ...
      <div id="projects-content">
        <div className="large-project-display">
          <ProjectDisplay title="Serif.nu" img={SerifScreenshot} large>
            ...
            <p className="project-summary-text">
              <a href="https://serif.nu">Serif.nu</a> is a course scheduling web
              app designed to help Northwestern students plan their course
              schedules more easily and quickly. The project aimed to address
              frustrations in using Northwestern&apos;s own course registration
              system, but it became my introduction to JavaScript and web
              development in general. The first version (created using{' '}
          ...
          <ProjectDisplay title="Census Reporter" img={CRScreenshot} large>
            <p className="project-summary-text">
              <a href="https://censusreporter.org">Census Reporter</a> aims to
              simplify access to U.S. census data. Since joining the team,
              I&apos;ve covered the full stack by implementing full-text search
              in the Census Reporter API, designing a search results page,
              generating sitemaps, and making data download files more
              human-friendly.
            </p>
            <p className="project-summary-text">
        ...
        <div className="small-project-display">
          <ProjectDisplay title="SQL Murder Mystery">
            ...
            <p className="project-summary-text">
              Inspired by the{' '}
              <a href="https://github.com/veltman/clmystery">
                command line mystery
              </a>
              , I created this{' '}
              <a href="https://github.com/NUKnightLab/sql-mysteries">
                SQL murder mystery
              </a>{' '}
              with the help of Cathy He and Joe Germuska as part of my work as a
              fellow at the Northwestern University{' '}
              <a href="https://knightlab.northwestern.edu/">Knight Lab</a>. We
              think it's a great way to learn or practice your SQL skills - hope
              you have fun solving the mystery!
            </p>
            <div className="project-summary-icons">
          ...
          <ProjectDisplay title="TeslaSpotting" img={TeslaLogo}>
            ...
            <p className="project-summary-text">
              Check it out on the{' '}
              <a href="https://play.google.com/store/apps/details?id=com.teslaspotting">
                Play Store
              </a>{' '}
