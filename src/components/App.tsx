        ...
        <div id="projects-content">
          <div className="large-project-display">
            <ProjectDisplay title="Serif.nu" img={SerifScreenshot} large>
              ...
              <div className="project-summary-icons">
                <IconButton onClick={() => navigateTo('https://github.com/Joonpark13/serif.nu')}>
            ...
            <ProjectDisplay title="Census Reporter" img={CRScreenshot} large>
              ...
              <div className="project-summary-icons">
                <IconButton onClick={() => navigateTo('https://github.com/censusreporter/censusreporter')}>
                  <span className="fa fa-github"></span>
                </IconButton>
                <IconButton onClick={() => navigateTo('https://github.com/censusreporter/census-api')}>
                  <span className="fa fa-github"></span>
                </IconButton>
              </div>
            </ProjectDisplay>
          ...
          <div className="small-project-display">
            <ProjectDisplay title="SQL Murder Mystery">
              ...
              <div className="project-summary-icons">
                <IconButton onClick={() => navigateTo('https://github.com/NUKnightLab/sql-mysteries')}>
                  <span className="fa fa-github"></span>
                </IconButton>
              </div>
            </ProjectDisplay>
            ...
            <ProjectDisplay title="TeslaSpotting" img={TeslaLogo}>
              ...
              <div className="project-summary-icons">
                <IconButton onClick={() => navigateTo('https://play.google.com/store/apps/details?id=com.teslaspotting')}>
                  <span className="fa fa-android"></span>
                </IconButton>
                <IconButton onClick={() => navigateTo('https://github.com/Joonpark13/tesla-spotting')}>
                  <span className="fa fa-github"></span>
                </IconButton>
              </div>
            </ProjectDisplay>
            ...
            <ProjectDisplay title="Superhero Fueling" img={SuperheroScreenshot}>
              ...
              <div className="project-summary-icons">
                <IconButton onClick={() => navigateTo('https://github.com/eecs394-f16/Superhero-Fueling')}>
                  <span className="fa fa-github"></span>
                </IconButton>
              </div>
            </ProjectDisplay>
            ...
            <ProjectDisplay title="JoonPark.me (v1)">
              ...
              <div className="project-summary-icons">
                <IconButton onClick={() => navigateTo('https://github.com/Joonpark13/joonpark.me-OLD')}>
                  <span className="fa fa-github"></span>
                </IconButton>
              </div>
            </ProjectDisplay>
      ...
      <ContentPage title="Contact">
        <div id="contact-content">
          ...
          <div id="sm" className="icons">
            <IconButton onClick={() => navigateTo('mailto:contact@joonpark.me')}>
              <span className="fa fa-envelope"></span>
            </IconButton>
            <IconButton onClick={() => navigateTo('https://www.linkedin.com/in/joonpark13/')}>
              <span className="fa fa-linkedin"></span>
            </IconButton>
            <IconButton onClick={() => navigateTo('https://github.com/Joonpark13/')}>
              <span className="fa fa-github"></span>
            </IconButton>
            <IconButton onClick={() => navigateTo('https://twitter.com/JoonParkMusic')}>
              <span className="fa fa-twitter"></span>
            </IconButton>
            <IconButton onClick={() => navigateTo('https://medium.com/@joon.park13')}>
              <span className="fa fa-medium"></span>
            </IconButton>
            <IconButton onClick={() => navigateTo('http://joonparkmusic.com/')}>
              <span className="fa fa-music"></span>
            </IconButton>
          </div>

          <div id="lg" className="icons">
            <IconButton className="contact-btn" onClick={() => navigateTo('mailto:contact@joonpark.me')}>
              <span className="fa fa-envelope fa-lg"></span>
            </IconButton>
            <IconButton className="contact-btn" onClick={() => navigateTo('https://www.linkedin.com/in/joonpark13/')}>
              <span className="fa fa-linkedin fa-lg"></span>
            </IconButton>
            <IconButton className="contact-btn" onClick={() => navigateTo('https://github.com/Joonpark13/')}>
              <span className="fa fa-github fa-lg"></span>
            </IconButton>
            <IconButton className="contact-btn" onClick={() => navigateTo('https://twitter.com/JoonParkMusic')}>
              <span className="fa fa-twitter fa-lg"></span>
            </IconButton>
            <IconButton className="contact-btn" onClick={() => navigateTo('https://medium.com/@joon.park13')}>
              <span className="fa fa-medium fa-lg"></span>
            </IconButton>
            <IconButton className="contact-btn" onClick={() => navigateTo('http://joonparkmusic.com/')}>
